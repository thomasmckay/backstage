...
/** @public */
export const ToolSearchResultListItemExtension = explorePlugin.provide(
  createSearchResultListItemExtension<ToolSearchResultListItemProps>({
    name: 'ToolSearchResultListItem',
    component: ToolSearchResultListItem,
